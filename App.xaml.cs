        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            using (var scope = Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    {
                        var snakePlant = new Models.Plant { Name = "Замиокулькас (Денежное дерево)", WateringInterval = 21, LightRequirement = "Теневыносливые", Variety = "Суккуленты" };
                        snakePlant.Sections.AddRange(new[]
                        {
                        ...
                        var monstera = new Models.Plant { Name = "Монстера Деликатесная", WateringInterval = 10, LightRequirement = "Теневыносливые", Variety = "Лианы" };
                        monstera.Sections.AddRange(new[]
                        {
