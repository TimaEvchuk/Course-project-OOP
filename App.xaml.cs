        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            using (var scope = Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    {
                        var snakePlant = new Models.Plant { Name = "Замиокулькас (Денежное дерево)", WateringInterval = 21, FertilizingInterval = 45, LightRequirement = "Теневыносливые", Variety = "Суккуленты", ImagePath = "Images/Plants/zamioculcas.png" };
                        ...
                        var monstera = new Models.Plant { Name = "Монстера Деликатесная", WateringInterval = 10, FertilizingInterval = 21, LightRequirement = "Теневыносливые", Variety = "Лианы", ImagePath = "Images/Plants/monstera.png" };
                        ...
                        var ficus = new Models.Plant { Name = "Фикус Бенджамина", WateringInterval = 7, FertilizingInterval = 14, LightRequirement = "Светолюбивые", Variety = "Лиственные", ImagePath = "Images/Plants/ficus.png" };
